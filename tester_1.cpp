...
int main(int argc, char** argv)
{
...

	{
		...
		{
			std::cout << "EXCEPTION: Message intended for [" << messages[0].m_toAddress << "]\n";
		}
...

	{
		...
		for (int i = 1; i < 10; ++i)
		{
			...
			{
				std::cout << "EXCEPTION: Message intended for [" << messages[i].m_toAddress << "]\n";
			}
		}
		server.showInbox();
		std::cout << "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n\n";
	...
	// Check bad filename exception for plugins
